    ...
    <Container className=''>
      ...
      <motion.div initial={{y:[100], opacity:0}}
         ...
         viewport={{once:true}} className='container flex items-center justify-around mt-24 mb-20'>
          ...
          <GsapMagnetic className='inline-block'>
            <svg className='fill-gray-700  hover:fill-[#ec4e39] cursor-pointer' id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 56.13 46.08">
