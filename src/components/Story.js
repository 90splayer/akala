...
export default function Story() {
    ...
    <Container >
      ...
      justify-center bg-gray-50 shadow-md py-8 px-12 gap-7 flex'>
       ...
       <div className="flex w-full items-center justify-center text-sm"><Link href='https://open.substack.com/pub/storystory?r=fprzy&utm_medium=ios' className='bg-yellow-500 px-4 py-2 rounded-md'>Read Chapters</Link>
      </div>
      </div>
      </Container>
    )
